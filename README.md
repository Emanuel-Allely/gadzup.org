# [Gadzup - Building the website](https://startbootstrap.com/theme/stylish-portfolio/)

I suggest to built the Gadzup.org website using [Stylish Portfolio](https://startbootstrap.com/theme/stylish-portfolio/) which is a responsive, one page portfolio theme for [Bootstrap](https://getbootstrap.com/) created by [Start Bootstrap](https://startbootstrap.com/). The theme features multiple content sections with an off canvas navigation menu.
